...
if (isset($_POST['id']) && isset($_POST['buy_quantity'])) {
    ...
    header("Location: buy-product.php");
    exit;
}
...
<body>
    ...
    <main class="w-50 mx-auto">
        ...
        <div class="row mb-3">
            <div class="col-6">
                <label class="form-label text-secondary">Total Price</label>
                <h1 class="form-control-plaintext">$ <?= $product['price'] * $buy_quantity ?></h1>
            </div>
            <div class="col-6">
                <label class="form-label text-secondary">Buy Quantity</label>
                <h1 class="form-control-plaintext"><?= $buy_quantity ?></h1>
        ...
        <form action="../actions/buy-product.php" method="post">
            <div class="row">
                <div class="col">
                    ...
                    <input type="hidden" name="quantity" value="<?= $product['quantity'] - $buy_quantity ?>">
                    <label for="buy-quantity" class="form-label text-secondary">Payment</label>
                    <input type="number" step="0.01" class="form-control" id="payment" name="payment" min="<?= $product['price'] * $buy_quantity ?>" required>
                </div>
            </div>
